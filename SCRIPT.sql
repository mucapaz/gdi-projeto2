...
INSERT INTO tb_aloca VALUES (
	tp_aloca (
		...
		(SELECT REF(E) FROM tb_evento E WHERE E.Codigo = 1)
	)
);
INSERT INTO tb_aloca VALUES (
	tp_aloca (
		...
		(SELECT REF(E) FROM tb_evento E WHERE E.Codigo = 3)
	)
);
INSERT INTO tb_aloca VALUES (
	tp_aloca (
		...
		(SELECT REF(E) FROM tb_evento E WHERE E.Codigo = 2)
	)
);
INSERT INTO tb_aloca VALUES (
	tp_aloca (
		...
		(SELECT REF(E) FROM tb_evento E WHERE E.Codigo = 5)
	)
);
INSERT INTO tb_aloca VALUES (
	tp_aloca (
		...
		(SELECT REF(E) FROM tb_evento E WHERE E.Codigo = 6)
	)
);
